...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = MotorDriver
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = MotorDriver_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SensorMod
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = SensorMod_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.4
 PARAMETER HW_INSTANCE = axi_gpio_shield_led
END
